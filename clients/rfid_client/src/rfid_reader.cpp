...
{
  // Halt the currently selected RFID card so it stops responding,
  // preventing repeated reads and allowing other cards to be detected.
  // The card remains powered and can be woken by REQA/WUPA or removal.
  _mfrc.PICC_HaltA();
